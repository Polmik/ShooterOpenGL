...
bool World::init_bonuses() {
    ...
    bonuses.push_back(Bonus({0, 0}, BonusType::Heal, HEALTH_BONUS_TEXTURE));
    bonuses.push_back(Bonus({0, 1}, BonusType::Ammo, AMMUNATION_BONUS_TEXTURE));
    bonuses.push_back(Bonus({0, 2}, BonusType::Speed, SPEED_BONUS_TEXTURE));
    bonuses.push_back(Bonus({0, 3}, BonusType::Vision, VIEW_BONUS_TEXTURE));
